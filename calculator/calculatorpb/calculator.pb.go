...
type SumRequest struct {
	...
	Num1 int32 `protobuf:"varint,1,opt,name=num1,proto3" json:"num1,omitempty"` //1 la so thu tu
...
func (x *PDNResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PDNResponse) ProtoMessage() {}

func (x *PDNResponse) ProtoReflect() protoreflect.Message {
	mi := &file_calculatorpb_calculator_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PDNResponse.ProtoReflect.Descriptor instead.
func (*PDNResponse) Descriptor() ([]byte, []int) {
	return file_calculatorpb_calculator_proto_rawDescGZIP(), []int{3}
}

func (x *PDNResponse) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x50, 0x44, 0x4e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a,
	...
	0x6f, 0x74, 0x32, 0xf3, 0x02, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f,
	...
	0x74, 0x6f, 0x72, 0x2e, 0x50, 0x44, 0x4e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x30, 0x01, 0x12, 0x46, 0x0a, 0x07, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x12, 0x1a,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x48, 0x0a, 0x07, 0x46,
	0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x12, 0x1a, 0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	0x74, 0x6f, 0x72, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x4d, 0x61, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x41, 0x0a, 0x06, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x12,
...
var file_calculatorpb_calculator_proto_goTypes = []interface{}{
	...
	(*PDNResponse)(nil),     // 3: calculator.PDNResponse
...
var file_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	8, // 4: calculator.CalculatorService.Square:input_type -> calculator.SquareRequest
	1, // 5: calculator.CalculatorService.Sum:output_type -> calculator.SumResponse
	3, // 6: calculator.CalculatorService.PrimeNumberDecomposition:output_type -> calculator.PDNResponse
	...
	9, // 9: calculator.CalculatorService.Square:output_type -> calculator.SquareResponse
...
func (x *calculatorServicePrimeNumberDecompositionClient) Recv() (*PDNResponse, error) {
	m := new(PDNResponse)
...
func (x *calculatorServicePrimeNumberDecompositionServer) Send(m *PDNResponse) error {
